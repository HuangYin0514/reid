...
class Baseline(nn.Module):
    ...
    def __init__(
        ...
        if pretrain_choice == "imagenet":
            ...
            pretrained_state_dict = model_zoo.load_url("https://download.pytorch.org/models/resnet50-19c8e357.pth")
            now_state_dict = self.base.state_dict()
            now_state_dict.update(pretrained_state_dict)
            self.base.load_state_dict(now_state_dict)
